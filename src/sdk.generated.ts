...
export class OrderService {
    ...
    async getPaginatedListOfOrders(): Promise<Record<string, any>> {
        return this.client.request("GET", "/order", undefined);
    }
    ...
    async getOrderById(orderId: string): Promise<OrderWithIncludes> {
        return this.client.request("GET", "/order/{orderId}".replace("{orderId}", orderId), undefined);
    }
    async updateExistingOrder(orderId: string, body?: {
        buyer_comment?: string;
        manager_comment?: string;
        status_id?: number;
        discount_percent?: number;
        ...
        return this.client.request("PUT", "/order/{orderId}".replace("{orderId}", orderId), body);
    }
    async createNewOrderPayment(orderId: string, body?: {
        payment_method_id?: number;
        payment_method?: string;
        amount: number;
        status?: string;
        ...
        return this.client.request("POST", "/order/{orderId}/payment".replace("{orderId}", orderId), body);
    }
    async createNewOrderExpense(orderId: string, body?: {
        expense_type_id?: number;
        expense_type?: string;
        amount: number;
        description?: string;
        ...
        return this.client.request("POST", "/order/{orderId}/expense".replace("{orderId}", orderId), body);
    }
    async updateExistingOrderPayment(orderId: string, paymentId: string, body?: {
        status?: string;
        description?: string;
    }): Promise<any> {
        return this.client.request("PUT", "/order/{orderId}/payment/{paymentId}".replace("{orderId}", orderId).replace("{paymentId}", paymentId), body);
    }
    async updateExistingOrderExpense(orderId: string, expenseId: string, body?: {
        status?: string;
        description?: string;
    }): Promise<any> {
        return this.client.request("PUT", "/order/{orderId}/expense/{expenseId}".replace("{orderId}", orderId).replace("{expenseId}", expenseId), body);
    }
    async attachTagToOrder(orderId: string, tagId: string, body?: any): Promise<any> {
        return this.client.request("POST", "/order/{orderId}/tag/{tagId}".replace("{orderId}", orderId).replace("{tagId}", tagId), body);
    }
    async deleteTagFromOrder(orderId: string, tagId: string): Promise<any> {
        return this.client.request("DELETE", "/order/{orderId}/tag/{tagId}".replace("{orderId}", orderId).replace("{tagId}", tagId), undefined);
    }
    async attachFileToOrder(orderId: string, fileId: string, body?: any): Promise<any> {
        return this.client.request("POST", "/order/{orderId}/attachment/{fileId}".replace("{orderId}", orderId).replace("{fileId}", fileId), body);
    }
    async deleteFileFromOrder(orderId: string, fileId: string): Promise<{
        status?: boolean;
    }> {
        return this.client.request("DELETE", "/order/{orderId}/attachment/{fileId}".replace("{orderId}", orderId).replace("{fileId}", fileId), undefined);
    }
...
export class StorageService {
    ...
    async getEntityListOfFiles(entityType: string, entityId: string): Promise<File[]> {
        return this.client.request("GET", "/storage/attachment/{entityType}/{entityId}".replace("{entityType}", entityType).replace("{entityId}", entityId), undefined);
    }
...
export class PipelinesService {
    ...
    async getPaginatedListOfPipelinesStatuses(pipelineId: string): Promise<Record<string, any>> {
        return this.client.request("GET", "/pipelines/{pipelineId}/statuses".replace("{pipelineId}", pipelineId), undefined);
    }
    ...
    async getPipelinesCard(cardId: string): Promise<Record<string, any>> {
        return this.client.request("GET", "/pipelines/cards/{cardId}".replace("{cardId}", cardId), undefined);
    }
    async updatePipelinesCard(cardId: string, body?: {
        title?: string;
        note?: string;
        status_id?: number;
        source_id?: number;
        ...
        return this.client.request("PUT", "/pipelines/cards/{cardId}".replace("{cardId}", cardId), body);
    }
    async createNewPipelinesCardPayment(cardId: string, body?: {
        payment_method_id?: number;
        payment_method?: string;
        amount: number;
        status?: string;
        ...
        return this.client.request("POST", "/pipelines/cards/{cardId}/payment".replace("{cardId}", cardId), body);
    }
    async updateExistingPipelinesCardPayment(cardId: string, paymentId: string, body?: {
        status?: string;
        description?: string;
    }): Promise<any> {
        return this.client.request("PUT", "/pipelines/cards/{cardId}/payment/{paymentId}".replace("{cardId}", cardId).replace("{paymentId}", paymentId), body);
    }
    async attachFileToPipelinesCard(cardId: string, fileId: string, body?: any): Promise<any> {
        return this.client.request("POST", "/pipelines/cards/{cardId}/attachment/{fileId}".replace("{cardId}", cardId).replace("{fileId}", fileId), body);
    }
    async deleteFileFromCard(cardId: string, fileId: string): Promise<{
        status?: boolean;
    }> {
        return this.client.request("DELETE", "/pipelines/cards/{cardId}/attachment/{fileId}".replace("{cardId}", cardId).replace("{fileId}", fileId), undefined);
    }
}
...
export class BuyerService {
    ...
    async getBuyerById(buyerId: string): Promise<BuyerWithIncludes> {
        return this.client.request("GET", "/buyer/{buyerId}".replace("{buyerId}", buyerId), undefined);
    }
    async updateExistingBuyer(buyerId: string, body?: {
        full_name: string;
        birthday?: string;
        email?: string[];
        phone?: string[];
        ...
        return this.client.request("PUT", "/buyer/{buyerId}".replace("{buyerId}", buyerId), body);
    }
...
export class CompanyService {
    ...
    async getCompanyById(companyId: string): Promise<CompanyWithIncludes> {
        return this.client.request("GET", "/companies/{companyId}".replace("{companyId}", companyId), undefined);
    }
    async updateExistingCompany(companyId: string, body?: {
        name: string;
        title?: string;
        bank_account?: string;
        notes?: string;
        ...
        return this.client.request("PUT", "/companies/{companyId}".replace("{companyId}", companyId), body);
    }
}
...
export class PaymentsService {
    ...
    async getPaginatedListOfExternalTransactions(): Promise<Record<string, any>> {
        return this.client.request("GET", "/payments/external-transactions", undefined);
    }
    async attachExternalTransactionToPayment(paymentId: string, body?: {
        transaction_id?: number;
        transaction_uuid?: string;
    }): Promise<Payment> {
        return this.client.request("POST", "/payments/{paymentId}/external-transactions".replace("{paymentId}", paymentId), body);
    }
}
...
export class ProductsService {
    ...
    async getProductById(productId: string): Promise<ProductWithIncludes> {
        return this.client.request("GET", "/products/{productId}".replace("{productId}", productId), undefined);
    }
    async updateExistingProduct(productId: string, body?: {
        name?: string;
        description?: string;
        pictures?: string[];
        currency_code?: string;
        ...
        return this.client.request("PUT", "/products/{productId}".replace("{productId}", productId), body);
    }
    async createNewProductOffers(productId: string, body?: {
        offers?: {
            sku?: string;
            barcode?: string;
            price?: number;
        ...
        return this.client.request("POST", "/products/{productId}/offers".replace("{productId}", productId), body);
    }
